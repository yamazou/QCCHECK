...
function write_cellXfs(cellXfs) {
	...
	cellXfs.forEach(function(c) {
		var attrs = ({}); for(var k in c) if(Object.prototype.hasOwnProperty.call(c, k)) attrs[k] = c[k];
		attrs.applyAlignment = 1;
		o[o.length] = (writextag('xf', '<alignment horizontal="center" vertical="center"/>', attrs));
	});
	o[o.length] = ("</cellXfs>");
...
function write_sty_xml(wb, opts) {
	...
	o[o.length] = ('<fonts count="1"><font><sz val="11"/><color theme="1"/><name val="Meiryo"/><family val="2"/><charset val="128"/><scheme val="minor"/></font></fonts>');
	o[o.length] = ('<fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill></fills>');
	o[o.length] = ('<borders count="1"><border><left style="thin"><color indexed="64"/></left><right style="thin"><color indexed="64"/></right><top style="thin"><color indexed="64"/></top><bottom style="thin"><color indexed="64"/></bottom><diagonal/></border></borders>');
