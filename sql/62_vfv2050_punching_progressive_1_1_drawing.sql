...
/* VFV2050 PUNCHING PROGRESSIVE 1/1: set drawing file (place PNG at server/public/drawings/VFV2050_PUNCHING_PROGRESSIVE_1_1.png). */
...
BEGIN
    ...
    SET
        drawing_no = N'VFV2050-PP11',
        drawing_name = N'PUNCHING PROGRESSIVE 1/1 PROCESS DRAWING',
        file_url = N'/drawings/VFV2050_PUNCHING_PROGRESSIVE_1_1.png',
    ...
    BEGIN
        ...
        VALUES (
            ...
            N'/drawings/VFV2050_PUNCHING_PROGRESSIVE_1_1.png',
