...
/* VGC 0160 (DB part_no VGC0160) PIERCING & BENDING 2/2 — PNG at server/public/drawings/VGC0160_PIERCING_BENDING_2_2.png */
...
BEGIN
    ...
    SET
        drawing_no = N'VGC0160-PB22',
        drawing_name = N'PIERCING & BENDING 2/2 PROCESS DRAWING',
        file_url = N'/drawings/VGC0160_PIERCING_BENDING_2_2.png',
    ...
    BEGIN
        ...
        VALUES (
            ...
            N'/drawings/VGC0160_PIERCING_BENDING_2_2.png',
