...
/* ZW 30180 (DB part_no ZW30180) BUFFING TRI ANGLE — PNG at server/public/drawings/ZW30180_BUFFING_TRI_ANGLE.png */
...
BEGIN
    ...
    SET
        drawing_no = N'ZW30180-BFTRI',
        drawing_name = N'BUFFING TRI ANGLE PROCESS DRAWING',
        file_url = N'/drawings/ZW30180_BUFFING_TRI_ANGLE.png',
    ...
    BEGIN
        ...
        VALUES (
            ...
            N'/drawings/ZW30180_BUFFING_TRI_ANGLE.png',
