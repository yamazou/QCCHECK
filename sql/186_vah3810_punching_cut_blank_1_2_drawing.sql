...
/* VAH3810 PUNCHING CUT BLANK 1/2: set drawing file (PNG at server/public/drawings/VAH3810_PUNCHING_CUT_BLANK_1_2.png). */
...
BEGIN
    ...
    SET
        drawing_no = N'VAH3810-PC12',
        drawing_name = N'PUNCHING CUT BLANK 1/2 PROCESS DRAWING',
        file_url = N'/drawings/VAH3810_PUNCHING_CUT_BLANK_1_2.png',
    ...
    BEGIN
        ...
        VALUES (
            ...
            N'/drawings/VAH3810_PUNCHING_CUT_BLANK_1_2.png',
